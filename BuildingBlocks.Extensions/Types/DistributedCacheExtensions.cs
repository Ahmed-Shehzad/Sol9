...
public static class DistributedCacheExtensions
{
    ...
    {
        var bytes = Encoding.UTF8.GetBytes(JsonSerializer.Serialize(value, JsonConfigurations.GetDefaultOptions()));
    ...
    private static bool TryGetValue<T>(this IDistributedCache cache, string key, out T? value)
    {
        ...
        value = JsonSerializer.Deserialize<T>(json, JsonConfigurations.GetDefaultOptions());
        return true;
    }
