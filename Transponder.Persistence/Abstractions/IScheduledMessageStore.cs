...
public interface IScheduledMessageStore
{
    ...
    /// </summary>
    Task<bool> CancelAsync(Guid tokenId, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets a scheduled message by token id.
    /// </summary>
    Task<IScheduledMessage?> GetAsync(Guid tokenId, CancellationToken cancellationToken = default);
}
