...
public record OrderTimeFrame : Range<TimeOnly>
{
    ...
    private OrderTimeFrame(DayOfWeek dayOfWeek, TimeOnly from, TimeOnly to) : base(from, to)
    {
        DayOfWeek = dayOfWeek;
    }
    ...
    public static OrderTimeFrame Create(DayOfWeek dayOfWeek, TimeOnly from, TimeOnly to)
    {
